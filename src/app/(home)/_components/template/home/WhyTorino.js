...
function WhyTorino() {
  return (
    <div className="mt-8 container mx-auto  p-4 overscroll-x-none    ">
        ...
        <div className="  md:basis-2/5 lg:mt-8 ">
          <div className="flex gap-2 items-center justify-center md:justify-start">
            <div className=" bg-gradient-to-r from-[#28A745] to-[#10411B]  rounded-full w-[30px] h-[30px] flex justify-center item-center md:w-[50px] md:h-[50px] ">
              <span className=" text-xl md:text-[32px] text-white mt-1 md:mt-4">
                ?
              </span>
            </div>
          ...
          <h3 className=" hidden md:block text-2xl font-medium my-4">
          ...
          <SwiperSlide className=" ">
            ...
            <SwiperSlide className="   ">
              <img
                ...
                className="w-[250px] h-[280px] lg:w-[300px] lg:h-[400px] rounded-3xl object-cover"
              />
            </SwiperSlide>
            <SwiperSlide className="   ">
              <img
                src="/images/slide2.jpg"
                className="w-[250px] h-[280px] lg:w-[300px] lg:h-[400px]  object-cover rounded-3xl"
              />
            </SwiperSlide>
            <SwiperSlide className="  ">
              <img
                src="/images/slide3.jpg"
                className="w-[250px] h-[280px] lg:w-[300px] lg:h-[400px] object-cover rounded-[30px]"
              />
            </SwiperSlide>
            <SwiperSlide className="  ">
              <img
