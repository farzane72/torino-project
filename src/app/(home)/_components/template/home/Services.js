function Services() {
  return (
    <div className="mt-8 container  mx-auto   overscroll-x-none  ">
      
        <div className=" h-[1px] w-full bg-black/15   "></div>
        <div className="flex flex-col gap-4 md:flex-row   md:justify-between p-4 ">
          <div className="flex gap-4 items-center justify-start md:w-[331px] md:h-[109px] ">
            ...
            <div className="flex  flex-col">
              <h3 className=" text-sm md:text-[20px] lg:text-[26px]">
                بصرفه ترین قیمت
              </h3>
              <p className="text-xs md:text-sm lg:text-base font-light text-wrap">
